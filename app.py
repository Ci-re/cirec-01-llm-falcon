...
try:
    ...
    logging.info("Vector search failed, trying Elastic Search")
...
if prompt := st.chat_input("What is up?"):
    ...
    with st.chat_message("assistant"):
        ...
        for chunk in response_gen(streaming_response=streaming_response):
            full_response = st.write_stream(response_gen(streaming_response=streaming_response))
            full_response += chunk
